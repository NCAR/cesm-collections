...
def seasonal_mean(esm_catalog_json, query, name='seasonal_mean', center_time=True, kwargs={}):
    ...
    return Collection(
        ...
        esm_collection_json=esm_catalog_json,
...
def global_annual_mean(esm_catalog_json, query, name='global_annual_mean', center_time=False, kwargs={}):
    """
    Instantiate a `funnel.Collection` object for computing 
    global annual mean timeseries - assumes working with atmosphere
    """
    postproccess = [operators.global_mean, operators.annual_average] 
    postproccess_kwargs = [{}, {}]    
